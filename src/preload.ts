...
contextBridge.exposeInMainWorld("optical", {
  ...
  getLensCatalogueSummary: () => ipcRenderer.invoke("optical:lens-summary"),
  ...
  getDashboard: () => ipcRenderer.invoke("optical:dashboard"),
  getRepairJobs: (search?: string) => ipcRenderer.invoke("optical:repair-jobs", search),
  getRepairJob: (id: number) => ipcRenderer.invoke("optical:repair-job", id),
  createRepairJob: (data: import("./types/optical").CreateRepairJobDTO) => ipcRenderer.invoke("optical:repair-create", data),
  updateRepairJob: (id: number, data: import("./types/optical").UpdateRepairJobDTO) => ipcRenderer.invoke("optical:repair-update", id, data),
  ...
  completeQualityInspection: (jobId: number, data: CompleteQualityInspectionDTO) => ipcRenderer.invoke("optical:qc-complete", jobId, data),
  returnForRemake: (jobId: number, performedBy?: string) => ipcRenderer.invoke("optical:return-for-remake", jobId, performedBy),
  getLabReceivingSummary: () => ipcRenderer.invoke("optical:lab-receiving-summary"),
