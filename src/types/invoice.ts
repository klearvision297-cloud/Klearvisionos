...
export interface InvoiceDetail extends InvoiceListRow {
  ...
  items: Array<{ id: number; inventoryId: number; itemCode: string; itemType: string; brand: string | null; category: string | null; model: string | null; color: string | null; size: string | null; quantity: number; sellingPrice: number; discount: number; total: number; remarks: string | null }>;
